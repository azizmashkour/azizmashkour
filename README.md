...
- Improved frontend performance by **30–50%** using Next.js SSR, ISR, and code splitting  
- Designed a reusable **design system**, reducing UI development time by **~30–40%**  
- Built **AI RAG pipelines** using Weaviate & pgvector for semantic search  
- Contributed to **zero-downtime production migrations (Rails 5 → Rails 6)**  
...
> "I don’t just write code. I build systems that scale and ship real product value."
